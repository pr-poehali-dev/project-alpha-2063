      ...
      <main>
        ...
        <section className="retro-vibe" id="about">
          <div>
            ...
            <p className="vibe-text">Мы работаем только на результат. Каждый автомобиль проходит через руки мастера с большим опытом. Профессиональная химия, современное оборудование и внимание к каждой детали — от дисков до подстаканников, вот наш подход! 
